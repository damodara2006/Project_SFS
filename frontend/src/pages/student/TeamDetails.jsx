          ...
          <section className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
            ...
            <div className="space-y-4">
              {metaDetails.map((item, idx) => (
                <div
                  key={idx}
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200"
                >
                  ...
                  <span className="text-base sm:text-lg font-semibold text-gray-800 sm:text-right">
                    {item.value}
                  </span>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {members.map((m) => {
                ...
                return (
                  <div
                    key={m.id}
                    className="backdrop-blur-xl bg-white/70 border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4"
                  >
