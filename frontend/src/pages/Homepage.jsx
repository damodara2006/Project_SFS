...
import WaveImage from "../components/WaveImage"; // import WaveImage
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-background-white via-primary-accent/5 to-background-light relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row gap-20">
            <div className="text-center p-10 rounded-3xl shadow-card hover:shadow-card-hover transition-all duration-500 shadow-xl hover:scale-105 transform group">
              <div className="w-20 h-20 mx-auto mb-8 bg-gradient-to-br from-primary-accent to-amber-500 rounded-3xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                <svg
                  className="w-10 h-10 text-background-white"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-text-secondary leading-relaxed">
                Tackle real-world problems in manufacturing, supply chain, and
            ...
            <div className="text-center p-10 rounded-3xl shadow-card hover:shadow-card-hover transition-all duration-500 shadow-xl hover:scale-105 transform group">
              ...
              <p className="text-text-secondary leading-relaxed">
                Form teams, work with mentors, and collaborate with industry
                experts to bring ideas to life.
              </p>
            </div>
            <div className="text-center p-10 rounded-3xl shadow-card hover:shadow-card-hover transition-all duration-500 shadow-xl hover:scale-105 transform group">
              <div className="w-20 h-20 mx-auto mb-8 bg-gradient-to-br from-primary-accent to-amber-500 rounded-3xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-text-secondary leading-relaxed">
                Get feedback from seasoned evaluators and refine your solutions
                for maximum impact.
              </p>
            </div>
          </div>
